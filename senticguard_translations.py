...
TRANSLATIONS = {
    "RO": {
        ...
        "tech_manual_label": "Scor Titlu",
        "tech_content_label": "Scor Conținut",
        "tech_final_label": "Scor final calculat (ponderat):",
        "tech_config_label": "Configurație actuală:",
        "tech_no_content": "Analiza conținutului nu este disponibilă pentru modul manual.",
        "weight_slider_label": "Pondere Conținut (vs Titlu)",
    ...
    "EN": {
        ...
        "tech_manual_label": "Title Score",
        "tech_content_label": "Content Score",
        "tech_final_label": "Final calculated score (weighted):",
        "tech_config_label": "Current configuration:",
        "tech_no_content": "Content analysis is not available for manual mode.",
        "weight_slider_label": "Content Weight (vs Title)",
